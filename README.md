...
To visualize the data you must download the code and the json/csv files and save them in the same folder. You also have to download Live Server. Then you just have to open the file shooting.html with Live Server.
